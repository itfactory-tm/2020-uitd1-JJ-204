...
<div id="container_php">
    ...
    <p id='naam' class='text-justify'><span class='font-weight-bold'> Naam:</span><span
                class='text-capitalize'> <?php echo $_POST["voornaam"];
            echo str_repeat('&nbsp;', 1);
            echo $_POST["achternaam"]; ?>
    <p id='email' class='text-justify'><span class='font-weight-bold'> Email: </span> <span
                class='text-capitalize'><?php echo $_POST["email"]; ?></p>
    <p id='nummer' class='text-justify'><span class='font-weight-bold'> nummer:</span><span
                class='text-capitalize'> <?php echo $_POST["landcode"]; ?></span><span
                class='text-capitalize'></span><span class='text-capitalize'></span><?php echo $_POST["nummer"]; ?></p>
    <p id='bericht'><span class='font-weight-bold'>uw bericht:</span></p>
    <p class='text-justify'><?php echo $_POST["bericht"]; ?><span class='text-capitalize'>
</span></p></div>
